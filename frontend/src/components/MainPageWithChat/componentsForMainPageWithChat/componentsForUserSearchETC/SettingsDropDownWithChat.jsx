...
import LogOutWithChat from "./coomponentsSettingDropDown/LogOutWithChat.jsx";


export default function SettingsDropDownWithChat() {
    ...
    return (
        <div className={"relative top-2.5 2xl:right-1.5 max-2xl:left-2 lg:right-3"}>
            ...
            <LogOutWithChat openIn={logOutOpen} onClose={() => setLogOutOpen(false)} title={"LOG OUT"} text={"Do you really want to log out?"}/>
        </div>
    )
}