...
export default function SearchWithChat() {
    ...
    return (
        <div className={"w-full flex xl:justify-end relative 2xl:right-10 xl:right-5 top-1.5"}>
            <Input
            ...
            />
            {requestForFinding &&
                <div className={"w-auto bg-[#0d0d0d] h-auto absolute top-[105%] border-1 rounded-2xl left-[10%] z-10"}>
